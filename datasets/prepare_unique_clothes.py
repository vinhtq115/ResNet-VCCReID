...
def prepare_vccr(root):
    ...
    for id in ids:
        ...
        for tracklet in tracklets:
            ...
            if (id, clothes_id) not in unique_clothes_map:
                unique_clothes_map[(id, clothes_id)] = len(unique_clothes_map)
            unique_clothes_id = unique_clothes_map[(id, clothes_id)]
            ...
            train_set.append(
                {'p_id': int(id),
                 ...
                 'clothes_id': unique_clothes_id
                 }
            )
    train_content = {
        'data': train_set,
        'num_pids': int(len(ids)),
        'num_clothes': len(unique_clothes_map)
    }
